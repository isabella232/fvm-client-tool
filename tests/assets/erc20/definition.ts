...
export interface Contract {
  ...
  Transfer: (account: Account, value: string, receiverAddr: string, transferAmount: number) => Promise<string>;
  ...
  Approval: (account: Account, value: string, spenderAddr: string, newAllowance: number) => Promise<string>;
}
